...
import pandas as pd
import os
from .ne_utils import n_get_chatbot_response
...
class RecommendationAgent():
    ...
    def recommendation_classification(self,pipe,tokenizer,messages):
    ...
    def get_response(self,pipe,tokenizer,messages):
        ...
        recommendation_classification = self.recommendation_classification(pipe,tokenizer,messages)
    ...
    def get_recommendations_from_order(self,pipe,tokenizer,messages,order):
        products = []
